...
async def cancell_all_buttons(_, message):
    ...
    buttons.ibutton("🗜️ Archiving", f"canall {MirrorStatus.STATUS_ARCHIVING}")
    ...
    buttons.ibutton("⏸️ Paused", f"canall {MirrorStatus.STATUS_PAUSED}")
    buttons.ibutton("🗑️ All", "canall all")
